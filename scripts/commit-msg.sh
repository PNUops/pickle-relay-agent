...
fail() {
  ...
  echo "  commit message format: 'type: subject' (type one of: feat fix docs test chore refactor perf build style ci revert merge), imperative, <=72 chars, no trailing period" >&2
  exit 1
}
